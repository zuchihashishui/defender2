...
.field static final zziju:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
...
# instance fields
.field private final zzijv:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Landroid/location/Location;",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/gms/location/LocationResult;->zziju:Ljava/util/List;
...
.method constructor <init>(Ljava/util/List;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/location/LocationResult;->zzijv:Ljava/util/List;
...
.method public static create(Ljava/util/List;)Lcom/google/android/gms/location/LocationResult;
    ...
    sget-object p0, Lcom/google/android/gms/location/LocationResult;->zziju:Ljava/util/List;
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    iget-object v0, p1, Lcom/google/android/gms/location/LocationResult;->zzijv:Ljava/util/List;

    invoke-interface {v0}, Ljava/util/List;->size()I

    move-result v0

    iget-object v2, p0, Lcom/google/android/gms/location/LocationResult;->zzijv:Ljava/util/List;
    ...
    :cond_1
    iget-object p1, p1, Lcom/google/android/gms/location/LocationResult;->zzijv:Ljava/util/List;

    invoke-interface {p1}, Ljava/util/List;->iterator()Ljava/util/Iterator;

    move-result-object p1

    iget-object v0, p0, Lcom/google/android/gms/location/LocationResult;->zzijv:Ljava/util/List;
...
.method public final getLastLocation()Landroid/location/Location;
    ...
    :cond_0
    iget-object v1, p0, Lcom/google/android/gms/location/LocationResult;->zzijv:Ljava/util/List;
