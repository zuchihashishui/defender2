...
.field private final zzisv:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
...
.field private final zzitc:Lcom/google/android/gms/maps/GoogleMapOptions;
...
.method constructor <init>(Landroid/view/ViewGroup;Landroid/content/Context;Lcom/google/android/gms/maps/GoogleMapOptions;)V
    ...
    iput-object v0, p0, Lcom/google/android/gms/maps/MapView$zzb;->zzisv:Ljava/util/List;

    iput-object p1, p0, Lcom/google/android/gms/maps/MapView$zzb;->zzita:Landroid/view/ViewGroup;

    iput-object p2, p0, Lcom/google/android/gms/maps/MapView$zzb;->zzitb:Landroid/content/Context;

    iput-object p3, p0, Lcom/google/android/gms/maps/MapView$zzb;->zzitc:Lcom/google/android/gms/maps/GoogleMapOptions;
...
.method public final getMapAsync(Lcom/google/android/gms/maps/OnMapReadyCallback;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/gms/maps/MapView$zzb;->zzisv:Ljava/util/List;
...
.method protected final zza(Lcom/google/android/gms/dynamic/zzo;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/maps/MapView$zzb;->zzisu:Lcom/google/android/gms/dynamic/zzo;
    ...
    :try_start_0
    iget-object p1, p0, Lcom/google/android/gms/maps/MapView$zzb;->zzitb:Landroid/content/Context;

    invoke-static {p1}, Lcom/google/android/gms/maps/MapsInitializer;->initialize(Landroid/content/Context;)I

    iget-object p1, p0, Lcom/google/android/gms/maps/MapView$zzb;->zzitb:Landroid/content/Context;

    invoke-static {p1}, Lcom/google/android/gms/maps/internal/zzbz;->zzdt(Landroid/content/Context;)Lcom/google/android/gms/maps/internal/zze;

    move-result-object p1

    iget-object v0, p0, Lcom/google/android/gms/maps/MapView$zzb;->zzitb:Landroid/content/Context;
    ...
    iget-object v1, p0, Lcom/google/android/gms/maps/MapView$zzb;->zzitc:Lcom/google/android/gms/maps/GoogleMapOptions;
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/gms/maps/MapView$zzb;->zzisu:Lcom/google/android/gms/dynamic/zzo;

    new-instance v1, Lcom/google/android/gms/maps/MapView$zza;

    iget-object v2, p0, Lcom/google/android/gms/maps/MapView$zzb;->zzita:Landroid/view/ViewGroup;
    ...
    iget-object p1, p0, Lcom/google/android/gms/maps/MapView$zzb;->zzisv:Ljava/util/List;
