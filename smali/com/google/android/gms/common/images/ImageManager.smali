...
# static fields
.field private static final zzfwr:Ljava/lang/Object;

.field private static zzfws:Ljava/util/HashSet;
...
.field private final zzfwu:Ljava/util/concurrent/ExecutorService;

.field private final zzfwv:Lcom/google/android/gms/common/images/ImageManager$zza;

.field private final zzfww:Lcom/google/android/gms/internal/zzbfl;
...
.field private final zzfwy:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Landroid/net/Uri;",
...
.field private final zzfwz:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Landroid/net/Uri;",
...
.method private constructor <init>(Landroid/content/Context;Z)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/images/ImageManager;->zzfwu:Ljava/util/concurrent/ExecutorService;

    const/4 p1, 0x0

    iput-object p1, p0, Lcom/google/android/gms/common/images/ImageManager;->zzfwv:Lcom/google/android/gms/common/images/ImageManager$zza;

    new-instance p1, Lcom/google/android/gms/internal/zzbfl;

    invoke-direct {p1}, Lcom/google/android/gms/internal/zzbfl;-><init>()V

    iput-object p1, p0, Lcom/google/android/gms/common/images/ImageManager;->zzfww:Lcom/google/android/gms/internal/zzbfl;

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, Lcom/google/android/gms/common/images/ImageManager;->zzfwx:Ljava/util/Map;

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, Lcom/google/android/gms/common/images/ImageManager;->zzfwy:Ljava/util/Map;

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, Lcom/google/android/gms/common/images/ImageManager;->zzfwz:Ljava/util/Map;
...
.method public static create(Landroid/content/Context;)Lcom/google/android/gms/common/images/ImageManager;
    ...
    :cond_0
    sget-object p0, Lcom/google/android/gms/common/images/ImageManager;->zzfwt:Lcom/google/android/gms/common/images/ImageManager;
...
.method private final zza(Lcom/google/android/gms/common/images/zzb;)Landroid/graphics/Bitmap;
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->zzfwv:Lcom/google/android/gms/common/images/ImageManager$zza;
...
.method static synthetic zza(Lcom/google/android/gms/common/images/ImageManager;)Ljava/util/Map;
    ...
    iget-object p0, p0, Lcom/google/android/gms/common/images/ImageManager;->zzfwx:Ljava/util/Map;
...
.method private final zza(Lcom/google/android/gms/common/images/zza;)V
    ...
    invoke-static {v0}, Lcom/google/android/gms/common/internal/zzc;->zzge(Ljava/lang/String;)V
...
.method static synthetic zzafm()Ljava/lang/Object;
    ...
    sget-object v0, Lcom/google/android/gms/common/images/ImageManager;->zzfwr:Ljava/lang/Object;

    return-object v0
.end method

.method static synthetic zzakc()Ljava/util/HashSet;
    .locals 1
...
.method static synthetic zzc(Lcom/google/android/gms/common/images/ImageManager;)Lcom/google/android/gms/internal/zzbfl;
    .locals 0

    iget-object p0, p0, Lcom/google/android/gms/common/images/ImageManager;->zzfww:Lcom/google/android/gms/internal/zzbfl;
...
.method static synthetic zzd(Lcom/google/android/gms/common/images/ImageManager;)Ljava/util/Map;
    ...
    iget-object p0, p0, Lcom/google/android/gms/common/images/ImageManager;->zzfwz:Ljava/util/Map;
...
.method static synthetic zze(Lcom/google/android/gms/common/images/ImageManager;)Ljava/util/Map;
    ...
    iget-object p0, p0, Lcom/google/android/gms/common/images/ImageManager;->zzfwy:Ljava/util/Map;
...
.method static synthetic zzf(Lcom/google/android/gms/common/images/ImageManager;)Ljava/util/concurrent/ExecutorService;
    ...
    iget-object p0, p0, Lcom/google/android/gms/common/images/ImageManager;->zzfwu:Ljava/util/concurrent/ExecutorService;
...
.method static synthetic zzh(Lcom/google/android/gms/common/images/ImageManager;)Lcom/google/android/gms/common/images/ImageManager$zza;
    ...
    iget-object p0, p0, Lcom/google/android/gms/common/images/ImageManager;->zzfwv:Lcom/google/android/gms/common/images/ImageManager$zza;
...
.method public final loadImage(Landroid/widget/ImageView;Landroid/net/Uri;I)V
    ...
    iput p3, v0, Lcom/google/android/gms/common/images/zza;->zzfxh:I
