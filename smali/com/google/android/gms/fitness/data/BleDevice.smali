...
.field private final zzgzx:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/String;",
...
.method constructor <init>(ILjava/lang/String;Ljava/lang/String;Ljava/util/List;Ljava/util/List;)V
    ...
    iput p1, p0, Lcom/google/android/gms/fitness/data/BleDevice;->zzeck:I

    iput-object p2, p0, Lcom/google/android/gms/fitness/data/BleDevice;->zzgzw:Ljava/lang/String;
    ...
    iput-object p1, p0, Lcom/google/android/gms/fitness/data/BleDevice;->zzgzx:Ljava/util/List;

    invoke-static {p5}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Lcom/google/android/gms/fitness/data/BleDevice;->zzgzy:Ljava/util/List;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v1, p0, Lcom/google/android/gms/fitness/data/BleDevice;->zzgzw:Ljava/lang/String;

    iget-object v3, p1, Lcom/google/android/gms/fitness/data/BleDevice;->zzgzw:Ljava/lang/String;
    ...
    iget-object v1, p1, Lcom/google/android/gms/fitness/data/BleDevice;->zzgzx:Ljava/util/List;

    iget-object v3, p0, Lcom/google/android/gms/fitness/data/BleDevice;->zzgzx:Ljava/util/List;

    invoke-static {v1, v3}, Lcom/google/android/gms/internal/zzbus;->zza(Ljava/util/List;Ljava/util/List;)Z

    move-result v1

    if-eqz v1, :cond_0

    iget-object v1, p0, Lcom/google/android/gms/fitness/data/BleDevice;->zzgzy:Ljava/util/List;

    iget-object p1, p1, Lcom/google/android/gms/fitness/data/BleDevice;->zzgzy:Ljava/util/List;

    invoke-static {v1, p1}, Lcom/google/android/gms/internal/zzbus;->zza(Ljava/util/List;Ljava/util/List;)Z
...
.method public getAddress()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/google/android/gms/fitness/data/BleDevice;->zzgzw:Ljava/lang/String;
...
.method public getDataTypes()Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/google/android/gms/fitness/data/BleDevice;->zzgzy:Ljava/util/List;
...
.method public getSupportedProfiles()Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/google/android/gms/fitness/data/BleDevice;->zzgzx:Ljava/util/List;
...
.method public hashCode()I
    ...
    iget-object v1, p0, Lcom/google/android/gms/fitness/data/BleDevice;->zzgzx:Ljava/util/List;
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    iget v0, p0, Lcom/google/android/gms/fitness/data/BleDevice;->zzeck:I
